...
impl SubSystemsModel {
    pub fn new() -> Self {
        ...
        sub_actions.insert().text("Start subsystem").data::<SubsystemMessage>(SubsystemMessage::Start);
        sub_actions.insert().text("Stop subsystem").data::<SubsystemMessage>(SubsystemMessage::Stop);
        sub_actions.insert().text("Autoremove packages").data::<SubsystemMessage>(SubsystemMessage::Autoremove);
        sub_actions.insert().text("Clean Package Manager Cache").data::<SubsystemMessage>(SubsystemMessage::CleanPackageManagerCache);


        let mut destructive_actions = segmented_button::Model::<SingleSelect>::default();

        destructive_actions.insert().text("Reset subsystem").data::<SubsystemMessage>(SubsystemMessage::Reset);
        destructive_actions.insert().text("Delete subsystem").data::<SubsystemMessage>(SubsystemMessage::Delete);
...
fn labelled_info(label: impl Into<String>, info: impl Into<String>) -> cosmic::Element<'static, Message> {
    widget::Column::new()
